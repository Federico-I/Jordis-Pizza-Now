...
function Button({ children, disabled, to, type}) {
  ...
  const styles = { 
    ...
    secondary: "font-semibold uppercase border-2 border-stone-300 text-stone-800 tracking-wide hover:bg-stone-300 transition-colors duration-400 hover:text-stone-800 focus:text-stone-800 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed md:py-3.5",
  };
