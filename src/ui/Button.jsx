...
function Button({ children, disabled, to, type}) {
  ...
  const styles = { 
    ...
    secondary: "font-semibold uppercase border-2 border-stone 300text-stone-800 tracking-wide hover:bg-yellow-300 transition-colors duration-400 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed md:py3.5",
  };
