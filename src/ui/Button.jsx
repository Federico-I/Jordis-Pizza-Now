...
function Button({ children, disabled, to, type}) {
  ...
  const style = {
    ...
    secondary: "inline-block rounded-full border-2 border-stone-300 uppercase font-semibold text-stone-400 tracking-wide transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5",
  }
